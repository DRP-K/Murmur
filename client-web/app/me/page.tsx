            ...
            {editing ? (
              <div className="flex items-center gap-2">
                <input
                  ...
                  maxLength={40}
                  className="flex-1 rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-sm text-zinc-800 focus:border-zinc-400 focus:outline-none"
                  onKeyDown={(e) => {
              ...
              <button
                ...
                className="flex items-center gap-1.5 text-lg font-semibold text-zinc-800 hover:text-zinc-600"
              >
